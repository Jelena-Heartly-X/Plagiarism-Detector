...
def check_plagiarism(input_text: str, loaded_files: dict, n: int = 3, threshold: float = 0.5) -> dict:
    ...
    for filename, content in loaded_files.items():
        ...
        # Insert file n-grams into a separate Trie for each file
        trie = Trie()
        for n_gram in file_n_grams:
            trie.insert(n_gram)

        # Check the overlap between input n-grams and the file's Trie
...
folder_path = "D:/E-books/SEM 3/ADS/Plagiarism Detector/text files"
